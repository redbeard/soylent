  ...
  loadDefaults: ()->
    ...
    @products.push new Product @elements, "Hain Pure Foods Sea Salt Iodized",
      [
        ...
        new ProductSource("iHerb.com (26 oz package)", "http://iherb.com/Hain-Pure-Foods-Iodized-Sea-Salt-26-oz-737-g/33293?rcode=JNB001", new Qty("26 oz"), new Qty("0.075769231 USD/oz")),
      ],
      new Qty("1.5 g"), [
    ...
    @products.push new Product @elements, "Salt Iodized (Generic)",
      [
        ...
        new ProductSource("iHerb.com (Hain Pure Foods Sea Salt Iodized 26 oz package)", "http://www.iherb.com/Hain-Pure-Foods-Iodized-Sea-Salt-26-oz-737-g/33293?rcode=JNB001", new Qty("26 oz"), new Qty("0.075769231 USD/oz")),
      ],
      new Qty("1.5 g"), [
        @elements.Sodium.in_quantity("590mg"),
        @elements.Chlorine.in_quantity("909.62mg"),
    ...
    @products.push new Product @elements, "NOW Foods Calcium/magnesium 1000/500 mg",
      [
        ...
        new ProductSource("iHerb.com (240 capsules)", "http://www.iherb.com/Now-Foods-Calcium-Magnesium-240-Softgels/461?rcode=JNB001", new Qty("240 count"), new Qty(".06366 USD/each")),
    ...
    @products.push new Product @elements, "NOW Foods Choline & Inositol 500mg 100 Capsules",
      [
        ...
        new ProductSource("iHerb.com (100 capsules)", "http://www.iherb.com/Now-Foods-Choline-Inositol-500-mg-100-Capsules/513?rcode=JNB001", new Qty("100 count"), new Qty(".0827 USD/each")),
      ],
      new Qty("1 count"), [
    ...
    @products.push new Product @elements, "Doctor's Best Lithium Orotate 125mg (200 tablets)",
      [
        ...
        new ProductSource("iHerb.com", "http://www.iherb.com/Doctor-s-Best-Best-Lithium-Orotate-200-Tablets/22628?rcode=JNB001", new Qty("200 count"), new Qty(".06495 USD/each")),
    ...
    @products.push new Product @elements, "NOW Foods Potassium Gluconate Powder",
      [
        new ProductSource("iHerb.com (1lb package)", "http://www.iherb.com/now-foods-potassium-gluconate-100-pure-powder-1-lb-454-g/13939?rcode=JNB001", new Qty("1lb"), new Qty("12.1 AUD/lb")),
    ...
    @products.push new Product @elements, "NOW Foods Potassium Chloride Powder",
      [
        new ProductSource("iHerb.com (8oz package)", "http://www.iherb.com/Now-Foods-Potassium-Chloride-Powder-8-oz-227-g/777?rcode=JNB001", new Qty("8 oz"), new Qty("0.55625 USD/oz")),
    ...
    @products.push new Product @elements, "NOW Foods Iron 18mg",
      [
        ...
        new ProductSource("iHerb.com (120 caps package)", "http://www.iherb.com/Now-Foods-Iron-18-mg-120-Veggie-Caps/10481?rcode=JNB001", new Qty("120 count"), new Qty("0.058333333 USD/each")),
      ],
      new Qty("1 count"), [
    ...
    @products.push new Product @elements, "Potassium Gluconate",
      [
        new ProductSource("iHerb.com (1lb package)", "http://www.iherb.com/Now-Foods-Potassium-Gluconate-100-Pure-Powder-1-lb-454-g/13939?rcode=JNB001", new Qty("1lb"), new Qty("12.10 USD/lb")),
    ...
    @products.push new Product @elements, "Methylsulfonylmethane (MSM)",
      [
        ...
        new ProductSource("iHerb.com (Solgar, MSM Powder, 8oz package)", "http://www.iherb.com/Solgar-MSM-Powder-8-oz-226-g/15230?rcode=JNB001", new Qty("8oz"), new Qty("1.2975 USD/oz")),
      ],
      new Qty("1300mg"), [
