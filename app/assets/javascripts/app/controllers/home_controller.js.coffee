window.HomeCtrl = [ '$scope', '$http', '$timeout', '$products_repository', '$elements_repository', ($scope, $http, $timeout, $products_repository, $elements) ->
  ...
  $scope.recipe = new Recipe [
    ...
    $products_repository.findBySubstring("Monosodium Phosphate")[0].in_quantity( new Qty("9g") ),
    ...
    $products_repository.findBySubstring("Calcium/magnesium")[0].in_quantity( new Qty("0.5 count") ),
