window.HomeCtrl = [ '$scope', '$http', '$timeout', '$products_repository', '$elements_repository', ($scope, $http, $timeout, $products_repository, $elements) ->
  ...
  $scope.recipe = new Recipe [
    ...
    $products_repository.findBySubstring("Fine Powdered Oats")[0].in_quantity( new Qty("150.0g") ),
    $products_repository.findBySubstring("Maltodextrin (BulkNutrients.com.au)")[0].in_quantity( new Qty("140.0g") ),
    ...
    $products_repository.findBySubstring("Fibre Cleanse")[0].in_quantity( new Qty("25 g") ),
    $products_repository.findBySubstring("Salt Iodized (Generic)")[0].in_quantity( new Qty("0.9 g") ),
